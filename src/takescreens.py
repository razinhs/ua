            ...
            if image_size <= 75000:
                ...
                if img_host and "imgbb" in img_host:
                    ...
                    if 75000 < image_size <= 10000000:
                        ...
                        retake = True
                elif img_host and img_host in ["ptpimg", "lensdump", "ptscreens", "onlyimage", "dalexni", "zipline", "passtheimage", "lostimg", "seedpool_cdn", "sharex", "utppm"]:
                    if meta['debug']:
                        console.print(f"[green]Image {image_path} meets size requirements for {img_host}.[/green]")
                else:
                    ...
                    try:
                        ...
                        if img_host and "imgbb" in img_host:
                            ...
                            if new_size > 75000 and new_size <= 10000000:
                                console.print(f"[green]Successfully retaken screenshot for: {image_path} ({new_size} bytes)[/green]")
                                valid_image = True
                        elif img_host and img_host in ["ptpimg", "lensdump", "ptscreens", "lostimg", "onlyimage", "dalexni", "zipline", "passtheimage", "seedpool_cdn", "sharex", "utppm"] and new_size > 75000:
                            console.print(f"[green]Successfully retaken screenshot for: {image_path} ({new_size} bytes)[/green]")
                            valid_image = True
            ...
            if image_size <= 75000:
                ...
                if img_host and "imgbb" in img_host:
                    ...
                    if 75000 < image_size <= 10000000:
                        ...
                        console.print(f"[red]Image {image_path} with size {image_size} bytes: does not meet size requirements for {img_host}, retaking.")
                        retake = True
                elif img_host and img_host in ["ptpimg", "lensdump", "ptscreens", "lostimg", "onlyimage", "dalexni", "zipline", "passtheimage", "seedpool_cdn", "sharex", "utppm"]:
                    if meta['debug']:
                        console.print(f"[green]Image {image_path} meets size requirements for {img_host}.[/green]")
                else:
                    console.print(f"[red]Unknown image host or image doesn't meet requirements for host: {img_host}, retaking.")
